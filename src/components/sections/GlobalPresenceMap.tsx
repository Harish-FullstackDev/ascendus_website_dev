    ...
    <section className="relative py-24 bg-white overflow-visible">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        >
          ...
          >
            Ascendus (Ascendus) combines local expertise with global delivery capabilities.<br />
