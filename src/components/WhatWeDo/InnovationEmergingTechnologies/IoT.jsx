...
export default function IoT() {
    return (
        <section className="w-full py-10 sm:py-16 px-8 sm:px-[50px]">
            ...
            >
                <h2 className="text-black text-xl font-semibold">Internet of Things (IoT)</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-[18px] max-w-[1182px] mx-auto">
                {CARDS.map((card, index) => (
                    ...
                    >
                        <p className="text-white text-base sm:text-lg sm:text-xl font-semibold">{card.title}</p>
