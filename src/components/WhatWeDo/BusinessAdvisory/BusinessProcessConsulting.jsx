...
export default function BusinessProcessConsulting() {
    ...
    return (
        <section className="w-full py-10 sm:py-[60px] px-8 sm:px-[40px] flex flex-col items-center gap-10 sm:gap-[69px]">
            <motion.div
            ...
            >
                <h2 className="text-black text-xl font-semibold">Business Process Consulting</h2>
