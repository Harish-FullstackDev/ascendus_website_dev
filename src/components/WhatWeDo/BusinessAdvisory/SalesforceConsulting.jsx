        ...
        <section className="relative z-10 w-full pt-10 sm:pt-16 pb-10 sm:pb-0">
            ...
            <div className="w-full mx-auto flex flex-col-reverse lg:flex-row">
                ...
                <motion.div
                    ...
                    className="relative w-full lg:max-w-[800px] self-center min-h-[400px] lg:h-[480px] bg-white shadow-[2px_2px_46px_rgba(0,0,0,0.15)] flex flex-col justify-center px-6 sm:px-16 py-12"
                >
                ...
                >
                    ...
                    <div className="absolute inset-x-6 bottom-6 flex flex-col gap-2 sm:bottom-8 lg:inset-x-auto lg:bottom-[24%] lg:left-[20.8%] lg:right-[14.5%]">
                        <h2 className="text-white text-xl sm:text-[28px] font-semibold">
