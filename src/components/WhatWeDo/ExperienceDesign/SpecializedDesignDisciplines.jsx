            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 w-full mx-auto">
                {COLUMNS.map((col, index) => (
                    <motion.div
                        ...
                        className={`group relative px-6 sm:px-8 py-8 sm:py-10 min-h-[380px] sm:min-h-[480px] overflow-hidden text-[#2E3033] transition-colors duration-300 hover:text-white flex items-center
                                /* Mobile */
