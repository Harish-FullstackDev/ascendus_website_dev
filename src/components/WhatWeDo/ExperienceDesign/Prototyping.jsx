...
export default function Prototyping() {
    return (
        <div className="relative w-full h-[420px] sm:h-[520px] overflow-hidden">
            ...
            >
                <h2 className="text-white text-xl sm:text-[32px] font-semibold">Prototyping</h2>
                <p className="text-white text-base sm:text-lg sm:text-2xl font-normal">From Concept to Clickable Reality</p>
