...
export default function UserResearchAndDesignSystems() {
    ...
    return (
        <section className="w-full pt-10 sm:pt-16 px-8 sm:px-0 flex flex-col items-center gap-8 sm:gap-16">
            ...
            >
                <h2 className="text-[#2E3033] text-xl sm:text-[28px] font-semibold">User Research & Design Systems
                </h2>
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between items-center gap-8 lg:gap-[100px] w-full lg:pl-[64px]">
                ...
                <div className="relative w-full lg:w-[50vw] lg:max-w-[950px] aspect-[687/581] mx-auto lg:mx-0 overflow-hidden">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <h2 className="text-base sm:text-2xl font-semibold leading-[1.4] sm:leading-[41px]">
                                {activeTab.desc}
                            </h2>
                        </motion.div>
                    </AnimatePresence>
