...
export default function IdentityAccessManagement() {
    ...
    return (
        <section className="w-full bg-[#ededed] py-10 sm:py-[51px] px-8 sm:px-[50px] flex flex-col items-center gap-10 sm:gap-[51px]">
            <motion.div
            ...
            >
                <h2 className="font-heading text-black text-2xl font-semibold">Identity &amp; Access Management</h2>
