    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-4">
                <h3 className="text-[#10161d] text-xl font-medium">{title}</h3>
                <p className="text-[#4a5568] text-base sm:text-lg font-light leading-normal">{desc}</p>
            </div>
        </motion.div>
    );
}
...
export default function WhyEnterprisePartnerWithUs() {
    return (
        <section className="w-full bg-white px-8 py-8 sm:px-[64px] sm:py-[64px] flex flex-col gap-10 sm:gap-[72px] items-center">
            <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, amount: 0.3 }}
            ...
            >
                <h2 className="text-[#2E3033] text-xl sm:text-[28px] font-semibold">Why Partner With Us</h2>
