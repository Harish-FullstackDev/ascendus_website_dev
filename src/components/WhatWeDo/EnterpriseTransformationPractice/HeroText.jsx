...
export default function HeroText() {
    ...
    const scrollToEngagementModels = () => {
            ...
            >
                ...
                {/* <div className="flex flex-wrap items-center gap-4 mt-8 sm:mt-10">
                    ...
                    <button
                        ...
                        className="rounded-[54px] border border-[#0a3a52] px-8 py-3 text-base sm:text-lg font-light text-[#0a3a52] transition-colors hover:bg-[#0a3a52] hover:text-white"
                    >
