...
export default function WhyItMatters() {
    return (
        <section className="relative w-full px-8 py-10 sm:px-[64px] sm:py-16 flex flex-col gap-8 sm:gap-10 overflow-hidden">
            ...
            >
                <h2 className="text-white text-xl sm:text-[28px] font-semibold">Why It Matters</h2>
                <p className="text-white/90 text-base sm:text-lg font-light">Most enterprises run more than one platform</p>
            </motion.div>
