...
function ServiceCard({ service }) {
    return (
        ...
        >
            ...
            <p className="text-[#55595E] text-base font-extralight leading-[1.59]">
                {service.desc}
            </p>
        </motion.div>
    );
    ...
    return (
        <section className="w-full bg-[#f3f6f9] px-6 py-10 sm:px-[64px] sm:py-[64px] flex flex-col gap-8 sm:gap-[54px]">
            ...
            >
                ...
                <p className="text-[#55595E] text-lg sm:text-2xl font-light sm:tracking-[0.24px] w-full sm:max-w-[518px]">
            ...
            {/* Mobile keeps the original stacked layout untouched — just now with all 6
                services in one column instead of a carousel (no arrows needed there). */}
            ...
            {/* sm and up: the original 3-per-row card layout, now paged — arrows (copied
