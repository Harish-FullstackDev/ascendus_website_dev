...
export default function WhyPartnerWithUs() {
    return (
        <section className="w-full bg-white pt-10 pb-8 sm:pt-16 sm:pb-[32px] px-8 sm:px-[64px] flex flex-col items-center gap-8">
            ...
            >
                <h2 className="text-[#2E3033] text-xl sm:text-[28px] font-semibold">Why Partner With Us For SAP</h2>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-y-8 sm:gap-x-[15.6%]">
                {REASONS.map((reason, index) => (
                    ...
                    >
                        ...
                        <p className="text-[#55595E] text-base sm:text-lg font-light leading-[1.3]">{reason.desc}</p>
                    </motion.div>
                ))}
            </div>
        </section>
