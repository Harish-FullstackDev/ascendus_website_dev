...
export default function OnepracticeTheWholeSAPLifecycle() {
    return (
        <section className="w-full bg-white px-8 py-8 sm:px-[64px] sm:py-[64px] flex flex-col sm:flex-row gap-8 sm:gap-[48px] items-start">
            <motion.div
