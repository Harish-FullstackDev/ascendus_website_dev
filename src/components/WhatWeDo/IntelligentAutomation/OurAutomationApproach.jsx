...
export default function OurAutomationApproach() {
    return (
        <section className="w-full py-10 sm:py-16 px-8 sm:px-[40px] flex flex-col items-center gap-10 sm:gap-[50px]">
            <motion.div
            ...
            >
                <h2 className="text-black text-xl font-semibold">Our Automation Approach</h2>
