...
export default function TeamAdoption() {
    return (
        <section className="w-full py-10 px-8 sm:p-[64px] bg-[#f5f6f6]">
            ...
            <div className="flex flex-col lg:flex-row lg:items-stretch gap-10 lg:gap-6 w-full">
                ...
                <div className="flex flex-col gap-10 lg:gap-[75px] w-full lg:flex-[654_1_0%]">
                    ...
                    >
                        <h2 className="text-[#2E3033] text-xl sm:text-[28px] font-semibold">Team Adoption &amp; Seamless Context</h2>
                    ...
                    >
                        {BOXES.map((box) => (
                            ...
                            >
                                <h2 className="text-[#2E3033] text-xl font-semibold">{box.title}</h2>
                                <p className="text-[#55595E] text-base sm:text-lg font-light leading-relaxed tracking-relaxed ">{box.desc}</p>
                            </div>
                        ))}
                    </motion.div>
                </div>
