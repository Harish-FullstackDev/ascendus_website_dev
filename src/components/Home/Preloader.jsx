  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 25; i++) {
      ...
      particle.style.background = `radial-gradient(circle, 
        rgba(0,97,175, 0.6) 0%, 
        rgba(0,97,175, 0.4) 35%, 
        rgba(0,142,89, 0.3) 70%, 
        transparent 100%)`;
    ...
    tl.to(smokeParticles, {
      ...
      .to(
        logo,
        {
          filter: "drop-shadow(0 0 30px rgba(0,142,89, 0.8))",
          duration: 0.8,
          yoyo: true,
          repeat: 1,
          ease: "power2.inOut",
    ...
    >
          ...
          <div
            ...
            style={{
              ...
              background: `radial-gradient(circle, 
                rgba(0,97,175, 0.3) 0%, 
                rgba(0,97,175, 0.2) 50%, 
                rgba(0,142,89, 0.1) 100%)`,
      ...
      <div ref={logoRef} className="relative z-10 flex items-center justify-center">
        <div className="relative">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#0061af] via-[#0061af] to-[#008e59] rounded-full blur-xl opacity-60 scale-150 animate-pulse" />

          {/* Logo */}
          <div className="relative w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48">
            <Image
              src="/Brand/Ascendus_Icon_Primary.svg"
              alt="Ascendus Logo"
              fill
        ...
        {Array.from({ length: 30 }, (_, i) => (
          <div
            ...
            style={{
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 100}%`,
              background: `linear-gradient(45deg, #0061af, #0061af, #008e59)`,
              boxShadow: "0 0 10px rgba(0,142,89, 0.8)",
