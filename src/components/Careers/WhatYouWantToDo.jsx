...
export default function WhatYouWantToDo() {
    return (
        <section className="max-w-[1400px] mx-auto px-4 sm:px-16 lg:px-8 pt-5 sm:pt-8 pb-5 sm:pb-8">
            <motion.div
            ...
            >
                <h2 className="text-xl sm:text-[28px] font-semibold text-[#2E3033]">Work Where Expertise Has Room to Grow.</h2>
                ...
                {CARDS.map((card) => (
                    ...
                    >
                        ...
                        <div className="p-5 text-center">
                            <h2 className="text-xl font-semibold text-[#2E3033]">{card.title}</h2>
                            <p className="mt-2 text-base sm:text-lg font-light text-[#55595E]">{card.description}</p>
                        </div>
                    </motion.div>
                ))}
            </motion.div>
