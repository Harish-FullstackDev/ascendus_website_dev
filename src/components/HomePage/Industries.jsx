        ...
        <section className="w-full bg-white pt-10 pb-10 sm:pt-16 sm:pb-16 overflow-x-hidden">
            <div className="w-full px-6 sm:px-[64px]">
                ...
                >
                    ...
                    <Link
                        href="/who-we-are"
                        className="shrink-0 border border-[#2d8ec5] px-8 py-3 text-lg font-light text-[#2E3033] text-center transition-colors hover:bg-[#00447A] hover:text-white whitespace-nowrap"
                    >
