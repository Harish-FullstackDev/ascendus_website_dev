        ...
        <section className="w-full bg-[#f3f6f9] pt-10 pb-10 sm:p-16 px-6 ">
            <div className="w-full flex flex-col gap-10 sm:gap-16">
                ...
                >
                    ...
                    <Link
                        href="/who-we-are"
                        className="group relative shrink-0 inline-flex h-[54px] items-center overflow-hidden rounded-full border border-[#2d8ec5] pl-1 pr-2 text-lg font-light text-[#2E3033] whitespace-nowrap"
                    >
