...
// tracks the arrow's diagonal exit/reappear swap in both directions. `key`
    ...
    return (
        ...
        >
            <span className="relative pb-[3px] text-lg font-light text-[#2E3033]">
                ...
                <span
                    key={state.key}
                    className={`absolute left-0 bottom-0 h-[0.5px] w-full origin-left bg-[#00447A] ${underlineAnimClass}`}
                />
            </span>
