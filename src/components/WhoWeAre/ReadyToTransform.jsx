...
import ctaBg from "@/assets/WhoWeAre/webp/Who_We_Are_CTA_DataCenter.webp";
            ...
            <section className="relative z-0 w-full overflow-hidden">
                ...
                >
                    ...
                    <button
                        ...
                        className="rounded-full border border-[#d3dae2] px-8 py-2 text-sm sm:text-base font-light text-white transition-colors hover:bg-white hover:text-black"
                    >
                        Book a Call
                    </button>
                </motion.div>
