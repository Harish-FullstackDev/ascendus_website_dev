        ...
        <section className="w-full px-8 sm:px-[64px] pt-10 pb-10 sm:pt-8 sm:pb-16">
            ...
            <div className="flex flex-col gap-16">
                <div className="text-center max-w-3xl mx-auto">
                    <h2 className="text-xl sm:text-[28px] font-semibold text-[#2E3033]">What Shapes How We Deliver</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-[18px]">
                    {PRINCIPLES.map((item, index) => (
                        ...
                        >
                            <h2 className="text-xl text-[#2E3033] font-semibold">
                                {item.title}
                            </h2>
                            <p className="font-light mt-4 leading-relaxed text-base sm:text-lg text-[#55595E]">
                                {item.description}
                            </p>
                        </div>
                    ))}
