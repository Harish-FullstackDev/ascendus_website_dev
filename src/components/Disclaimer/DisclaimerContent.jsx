...
import { sections, sectionContent } from "./disclaimerData";
    ...
    <div className="relative w-full bg-white">
      ...
      <div className="bg-[#dadada] px-[59px] py-[38px]">
        <div className="max-w-[1280px] mx-auto flex flex-col gap-[7px] text-black">
          <p className="font-medium">Label Version: 1.0</p>
          <p className="font-normal">Last updated on: 16th September 2026</p>
        </div>
      </div>
    </div>
  );
