      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-16">
        ...
        >
          ...
          <p className="text-gray-600 text-lg leading-relaxed max-w-4xl mx-auto">
            Ascendus (Ascendus) began with a vision to bring
        ...
        <div className="relative">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 top-0 h-full">
            ...
            <motion.div
              ...
              className="relative mx-auto w-[2px] h-full bg-gradient-to-b from-cyan-400 via-blue-500 to-cyan-300 shadow-[0_0_15px_rgba(102,205,243,0.5)]"
            />
          </div>
